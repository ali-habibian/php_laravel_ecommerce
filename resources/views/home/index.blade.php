                                                    ...
                                                    <li>
                                                        @auth
                                                            @if($product->existsInUserWishList(auth()->user()))
                                                                <a href="{{ route('home.wishlist.toggle', $product) }}">
...
{{--                                                    <li> because we have variations and user should select it first then add to basket --}}
{{--                                                        <a href="#">--}}
...
{{--                                                    </li>--}}
    ...
    {{-- Testimonial Area (Users Comments) --}}
